...
{
    public static bool IsAppenderDefined<TAppender>(this ILoggerRepository repository) where TAppender : IAppender
    {
    ...
    public static bool IsAppenderInRoot<TAppender>(this ILoggerRepository repository) where TAppender : IAppender
    {
    ...
    public static bool IsAppenderExists<TAppender>(this ILoggerRepository repository) where TAppender : IAppender
    {
        return IsAppenderDefined<TAppender>(repository) && IsAppenderInRoot<TAppender>(repository);
    }

    public static TAppender? GetAppender<TAppender>(this ILoggerRepository repository) where TAppender : IAppender
    {
