...
namespace CloudPillar.Agent.Tests
{
    ...
    public class D2CMessengerHandlerTestFixture
    {
        ...
        public async Task SendFirmwareUpdateEventAsync_ByTransportType_SendCorrectChunkSize(TransportType transportType, int expectedChunkSize)
        {
            ...
            await _target.SendFirmwareUpdateEventAsync(CancellationToken.None, CHANGE_SPEC_ID, FILE_NAME, 0, "0", START_POSITION, END_POSITION);
        ...
        public async Task SendFirmwareUpdateEventAsync_Failure_ThrowException()
        {
            ...
            {
                await _target.SendFirmwareUpdateEventAsync(CancellationToken.None, CHANGE_SPEC_ID, FILE_NAME, 0);
            });
        }
        ...
        private bool CheckMessageContent(Message msg, int chunkSize, string changeSpecId, string fileName, int actionIndex, long? startPosition, long? endPosition)
        {
            ...
            return firmwareUpdateEvent.ChunkSize == chunkSize &&
                  ...
                  firmwareUpdateEvent.ChangeSpecId == changeSpecId;
        }
