...
public class D2CMessengerHandler : ID2CMessengerHandler
{
    ...
    public async Task SendFirmwareUpdateEventAsync(string fileName, string actionId/*, TwinPatchChangeSpec changeSpecKey*/, long? startPosition = null, long? endPosition = null)
    {
    ...
    public async Task SendStreamingUploadChunkEventAsync(byte[] buffer, Uri storageUri, string actionId, long currentPosition, string checkSum, bool fromRunDiagnostic)
    {
