...
public interface ID2CMessengerHandler
{
    ...
    Task SendStreamingUploadChunkEventAsync(byte[] buffer, Uri storageUri, string actionId, long currentPosition, string checkSum, CancellationToken cancellationToken, bool fromRunDiagnostic = false);
