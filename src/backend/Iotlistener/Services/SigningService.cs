...
public class SigningService : ISigningService
{
    ...
    public async Task CreateFileKeySignature(string deviceId, SignFileEvent signFileEvent)
    {
        try
        {
            ...
            string signRequestUrl = $"{_environmentsWrapper.beApiUrl}ChangeSpec/CreateFileSign?deviceId={deviceId}&propName={signFileEvent.PropName}&actionIndex={signFileEvent.ActionIndex}&changeSpecKey={signFileEvent.ChangeSpec}";
